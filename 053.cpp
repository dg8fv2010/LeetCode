 ...
 * 举个例子，-1， -2 ，4， -5， 7这里假定7为第k+1个元素，那么很明显可以看出，
 * 之前的sum = -5 + 4 =-1，那么这样对于7来说只会减少它，所以直接置sum = 0， 0 + 7才能得到正确的答案。
 * 再拓展这个数组， -1， -2， 4， -5， 7， 1 这里1之前的sum = 7 > 0，
 * 对于后面的1来组成最大子序列是有贡献的，所以sum = 7 + 1 =8。
